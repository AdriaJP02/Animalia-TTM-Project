...
load_data(main_data_dir)



def create_file_lists(main_data_dir):
    """Collects file lists for each instrument from the downloaded data.
  """
    inst_files = dict()
...
#Print the list of files of animals
inst_files = create_file_lists(main_data_dir)
print("List of files: ",inst_files)
...
segment_files = create_segments_dir(segments_dir)
